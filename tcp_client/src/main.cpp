...
const char *ssid_Router     =  "ROUTER_NAME"; //Enter the router name
const char *password_Router =  "ROUTER_PASSWORD"; //Enter the router password
#define     REMOTE_IP          "IP_TO_CONNECT_TO"  //input the remote server which is you want to connect
